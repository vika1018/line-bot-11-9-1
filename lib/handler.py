...
class ChatbotHandler():
    ...
    def __init__(self, load_clients, redis=None):
        self.handler = WebhookHandler(os.environ.get('7e2526361af1800f787f38d7de4ab065'))
        self.bot = LineBotApi(os.environ.get('hmDdVp5SnY9VouuOj0x72AsaMqbTed27zRlnvL6shzvf+CZElkGgG8uwcNpuqfwk2zBfBPruIbJXy/NLopDInm3ULnWQxjtrtlcdfnFEuwDnl6v2ByeJLSh3U5rpuDimHIRZKZl5f6kgYH7Tf4I6FgdB04t89/1O/w1cDnyilFU='))
